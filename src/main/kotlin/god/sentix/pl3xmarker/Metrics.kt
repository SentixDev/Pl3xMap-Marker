...
class Metrics(plugin: JavaPlugin, serviceId: Int) {
    ...
    /**
     * Creates a new god.sentix.pl3xmarker.Metrics instance.
     *
    ...
    class MetricsBase(
        ...
        private fun startSubmitting() {
            ...
            // and second delay.
            // WARNING: You must not modify and part of this god.sentix.pl3xmarker.Metrics class, including the submit delay or
            // frequency!
        ...
        private fun submitData() {
            ...
            val chartData = customCharts.stream()
                ...
                .filter { obj: JsonObjectBuilder.JsonObject? ->
                    Objects.nonNull(
                        obj
                    )
                }
                .toArray<JsonObjectBuilder.JsonObject> { arrayOf() }
            serviceJsonBuilder.appendField("id", serviceId)
            serviceJsonBuilder.appendField("customCharts", chartData)
            baseJsonBuilder.appendField("god/sentix/pl3xmarker/servicetix/pl3xmarker/service", serviceJsonBuilder.build())
        ...
        private fun sendData(data: JsonObjectBuilder.JsonObject) {
            ...
            connection.setRequestProperty("User-Agent", "god.sentix.pl3xmarker.Metrics-Service/1")
        ...
        private fun checkRelocation() {
            ...
            if ((System.getProperty("bstats.relocatecheck") == null
                ...
                if ((MetricsBase::class.java.getPackage().name.startsWith(defaultPackage)
                    ...
                    throw IllegalStateException("bStats god.sentix.pl3xmarker.Metrics class has not been relocated correctly!")
                }
            }
        }

        companion object {
            /** The version of the god.sentix.pl3xmarker.Metrics class.  */
            val METRICS_VERSION = "2.2.1"
            private val scheduler = Executors.newScheduledThreadPool(1,
                { task: Runnable? -> Thread(task, "bStats-god.sentix.pl3xmarker.Metrics") })
